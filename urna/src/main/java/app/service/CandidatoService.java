...
public class CandidatoService {
    ...
    public Candidato buscarPorFuncaoENumero(Integer funcao, Integer numero) {
        Optional<Candidato> candidato = candidatoRepository.findByFuncaoAndNumero(funcao, numero);
        return candidato.orElse(null); 
    }
