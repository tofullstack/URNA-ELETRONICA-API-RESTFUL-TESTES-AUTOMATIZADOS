...
public class CandidatoController {
    ...
    @GetMapping("/buscarPorFuncaoENumero/{funcao}/{numero}")
    public ResponseEntity<Candidato> buscarCandidatoPorFuncaoENumero(@PathVariable Integer funcao, @PathVariable Integer numero) {
        Candidato candidato = candidatoService.buscarPorFuncaoENumero(funcao, numero);
        return new ResponseEntity<>(candidato, HttpStatus.OK);
